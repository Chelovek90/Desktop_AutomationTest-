...
public class WellsTreeProject extends BaseTreeProject {
    ...
    protected List<RemoteWebElement> wellsList;
    ...
    @FindBy(name = "Geosteering.UI.Controls.DataTreeView.DataTree.WellsTreeViewItem")
    protected RemoteWebElement wellsTopButton;
    @FindBy(name = "Geosteering.UI.Controls.DataTreeView.DataTree.WellTreeViewItem")
    private List<RemoteWebElement> wells;
    ...
    public void clickWellsTopTree() {
        if (checkExpander(wellsTopButton)) {
            RemoteWebElement wellTopButton = (RemoteWebElement) wellsTopButton.findElementByClassName(clickablePoint);
            horizontalScroll(mainView, wellTopButton);
            doubleClick(wellTopButton);
        }
    }
